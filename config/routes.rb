ActionController::Routing::Routes.draw do |map|
  ...
  map.connect '/edit_custom_css', :controller => "user", :action => "edit_custom_css"
  ...
  map.connect '/imagez', :controller => "posts", :action => "imagebrowser"
  map.connect '/random', :controller => "posts", :action => "random"
